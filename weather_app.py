...
def updates():
    ...
    ss = datetime.fromtimestamp(weather.sunset_time(), pytz.timezone("Asia/Kolkata")).strftime("%I:%M %p")
    ...
    creators = '<p style="font-family:Source Sans Pro; color:#09ab3b; font-size:20px; text-align:right;">Made by</p><p style="font-family:Source Sans Pro; color:#09ab3b; font-size: 15px; text-align:right;">Yaseen, Venu, and Aditya</p>'
